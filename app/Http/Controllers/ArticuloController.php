...
class ArticuloController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request)
        {
            ...
            $articulo=DB::table('articulo')->where('nombre','LIKE','%'.$query.'%')
    ...
    public function store (ArticuloFormRequest $request)
    {
        ...
        //El campo idcategoria es un campo foraneo de la tabla categoria, debo buscar la consulta en donde seleccione el nombre de la categoria de la tabla categoria y a su vez en el articulo
